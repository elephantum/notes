...
It is also possible to send unchanged h264 from usb cam:

```
gst-launch-1.0     v4l2src device=/dev/video1 ! "video/x-h264,width=640,height=480" !     rtph264pay config-interval=3 aggregate-mode=zero-latency !     udpsink host=192.168.0.106 port=10001
```